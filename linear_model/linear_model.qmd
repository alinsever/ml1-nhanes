...
# 3.1 Introduction to Linear Modeling
...
AlcoholDay/SmokeNow are driving most most of the loss loss
...
# 3.3 Exploratory Analysis (EDA)

## 3.3.1 Outcome distribution (BMI)
...
## 3.3.2 Pairwise relationships with BMI (continuous predictors)
...
## 3.3.3 BMI vs Categorical predictors
...
## 3.4.3 Adding Socioeconomic factors
...
## 3.4.4 Adding Lifestyle & Clinical predictors

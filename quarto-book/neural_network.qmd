...
The **second approach** involved a deeper neural network, with four hidden layer instead of one. This enable the network to learn more complexe patterns, that a shallow network cannot grasp.
